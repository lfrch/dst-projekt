...
## Unser Firmen interner Arbeitsmodus

**In Slides als Action Title einbauen!**
- Unsere Vollzeitbeschäftigten erreichen bei einer 5 Tage Arbeitswoche eine Anzahl von 40 Stunden
- Ein Geschäftsjahr hat ca. 220 Werktage exkl. der gesetzlichen Feiertagen und individuellem Urlaubsanspruch
- Vollzeitbeschäftigte kommen damit also auf ca. 1760h pro Jahr
...
## Hours Worked im Detail {.unnumbered .unlisted}
...
OECD & Europa Daten zum Vergleich hinzugezogen
</div>
...
# Markers
linechart_points = alt.Chart(df_selectedlocations[df_selectedlocations['LOCATION'].isin(['United Kingdom', 'Germany'])]).mark_point(size=70, filled=True, opacity=1).encode(
    x=alt.X('TIME:O', title='Year'),
    y=alt.Y('VALUE', title='Number of Hours'),
    color=alt.Color('LOCATION', scale=colors),
    tooltip=['LOCATION']
)

# Chart 1 - Final Viz
linechart1_final = alt.layer(linechart1, linechart_labels,linechart_points).configure_view(
    strokeWidth=0
).configure_title(
    fontSize=25,
    anchor='start',
