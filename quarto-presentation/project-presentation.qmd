...
subtitle: "Entscheidungsfindung auf der Grundlage von VIsionaryZ Firmendaten"
author: "Lea Frech"
execute: 
    eval: true
lang: de
...
Dazu ein paar Eckdaten zur aktuellen Lage:

- Unser Hauptstandort in UK testet aktuell das New-Work-Konzept der 4-Tages-Woche
- Seit Eröffnung des zweiten Standorts in Deutschland, gilt es interne Daten zu beleuchten und - auch vergleichend zu den Kollegen in UK, bestehende Arbeitsmodi zu hinterfragen und ggf. zu testen -> *evtl. an Formulierung schrauben!*
...
::: {.column width="40%"}
<text style="font-size:smaller">Im Verhältnis stehen unsere beiden Firmenstandorte mit der OECD^[Organisation für wirtschaftliche Zusammenarbeit und Entwicklung], ein zur Gesamtheit der Länder repräsentativer Zusammenschluss und der EU</text>
...
## Aus der Mitarbeiterperspektive heraus
...
* Um"dichten" zu ActionTitle mit Aussage!
...
## steigende Produktivität: GDP X {.unlisted}

*Headline in entsprechender Farbe einfärben, ggf. Wert vor UK & GER Label schreiben?
...
<text style="color:#ff6361">GDP 1,05</text><br>

:::

::: {.column width="50%"}
<text style="color:#ffa600">GDP 1,02</text>
:::
...
## Implikationen
*noch nicht so smooth*
<div>
- **Ausgangslage:** Anzahl der Arbeitsstunden über die letzten Jahre:
- **Perspektive der Mitarbeiter:** Mindestanzahl an Arbeitsstunden: 
...
- Momentaufnahme: 2023 war ein starkes Jahr
</div>
...
::: {.column}
<div style="font-size:25pt">
- New Work Konzepte werden immer relevanter
...
Bei einer **4-Tages-Woche** wären es dagegen **ca. 1.470h im Jahr**

## Handlungsempfehlung
### Datenerhebung innerhalb eines Piloten

**Eine 4-Tage Woche triggert möglicherweise Veränderungen, die Folgen haben**
*Tonspur Auf Basis des Daten und deren Auswertung schlage ich folgendes vor:*
...
- Studien zeigen womöglich Steigerung der Produktivität trotz geringere Stundenwoche
- UK als Vorreiter <br>
</div>
...
- Verschiedene Konzepte wie 4x8h also 32h/Woche oder 4x10 also nach wie vor 40h/Woche
